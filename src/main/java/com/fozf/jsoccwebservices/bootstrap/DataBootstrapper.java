...
public class DataBootstrapper implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        template1.setCourseTemplateCode("1234");
        template1.setCourseTitle("Basic Programming in Java");

        CourseTemplate template2 = new CourseTemplate();
        template2.setCourseProgrammingLanguage("Python");
        template2.setCourseTemplateCode("1232");
        template2.setCourseTitle("Basic Programming in Python");
